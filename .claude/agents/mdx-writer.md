...
1. 틀린 내용, 문법, 오탈자 검수
2. 문장 표현을 개선하고 보완이 필요한 부분을 파악

**조금이라도 달라지는 모든 부분에 대해 반드시 AskUserQuestion으로 승인 필수. 수십~수백 번이라도 상관없음:**

- 없는 내용 추가 (예시 코드, 설명 포함)
- 기존 내용 삭제 또는 축약
- 잘못된 정보 수정
- 문장 표현 변경 또는 다듬기 (의미가 달라질 수 있는 경우에만)
- frontmatter 필드값 변경
- 섹션 구조 변경

**질문 형식**: 변경 이유와 변경 전/후 내용을 함께 보여주며 승인 요청.
