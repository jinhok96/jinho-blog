...
- RSS 피드 기반 기술 블로그 자동 수집 및 Gemini API(gemini-2.5-flash-lite)로 한국어 번역 후 글 생성
...
- **번역 콘텐츠 자동화** — 매일 UTC 02:00 GitHub Actions 실행 → RSS 피드 신규 글 감지 → Gemini API 번역 → `mdx` 브랜치에 자동 커밋&PR&병합
