      ...
      return (
        <Code
          className={`
            ...
            in-[h2]:not-group-has-[pre]/code:mb-1.5!
            in-[h3]:not-group-has-[pre]/code:mb-1!
            in-[h4]:not-group-has-[pre]/code:mb-0.75!
            in-[h5]:not-group-has-[pre]/code:mb-0.75!
            in-[h6]:not-group-has-[pre]/code:mb-0.75!
          `}
          language={language}
          {...props}
        />
