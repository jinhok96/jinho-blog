...
export type PortfolioCategory = 'web' | 'mobile' | 'design' | 'ui-ux';

export type ProjectCategory = 'open-source' | 'personal' | 'client';

export type LibraryCategory = 'ui' | 'hooks' | 'utils' | 'state-management';
